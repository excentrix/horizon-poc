    ...
    <div className={`relative w-[500px] ${className}`}>
      <div
        ...
        className={`max-h-[320px] overflow-y-auto py-2 ${
          displayScrollbar
            ? "[&::-webkit-scrollbar]:w-[6px] [&::-webkit-scrollbar-track]:bg-[color-mix(in oklab, #ffea96 50%, transparent)] [&::-webkit-scrollbar-thumb]:bg-[#ffea96] [&::-webkit-scrollbar-thumb]:rounded-[4px]"
            : "scrollbar-hide"
        }`}
        ...
        style={{
          ...
          scrollbarColor:
            "#ffea96 color-mix(in oklab, #ffea96 50%, transparent)",
        }}
      >
        {items.map((item, index) => (
          ...
          >
            <div
              className={`p-5 bg-[#111] rounded-lg ${
